...
var message = new Vue({
    ...
    data:{
        items: [
            {text: "信息1", id: 1, readStatus: false},
            {text: "信息2", id: 2, readStatus: true},
            {text: "信息3", id: 3, readStatus: true},
            {text: "信息4", id: 4, readStatus: false},
            {text: "信息5", id: 5, readStatus: false},
            {text: "信息6", id: 6, readStatus: false}
            ],
        unread:4
    },
    methods: {
